import 'https://raw.iqiq.io/2hacc/TVBox/main/drpy/lib/util.js';
...
function init(ext) {
    ...
    try {
        ...
        if (typeof (globalThis.mubanJs) === 'undefined') {
            // let mubanJs = request('https://gitcode.net/qq_32394351/dr_py/-/raw/master/js/模板.js', { 'User-Agent': MOBILE_UA }); 原始地址
            let mubanJs = request('https://raw.iqiq.io/2hacc/TVBox/main/drpy/lib/模板.js', { 'User-Agent': MOBILE_UA });
